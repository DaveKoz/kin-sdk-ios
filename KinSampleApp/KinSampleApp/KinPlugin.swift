...
struct _Provider: ServiceProvider {
	public let url: URL
	public let network: Network
	
	static public let Test = _Provider( url: URL( string: "http://horizon-testnet.kininfrastructure.com" )!, network: .testNet )
	static public let Main = _Provider( url: URL( string: "https://horizon-ecosystem.kininfrastructure.com" )!, network: .mainNet )
...
//        UnitySendMessage( "KinManager", method, param )
	...
	{
		let provider = environment == 0 ? _Provider.Test : _Provider.Main
